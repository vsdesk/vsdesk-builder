...
class Module extends \yii\base\Module implements BootstrapInterface
{
    ...
    public $controllerNamespace = 'vsdesk\builder\controllers';
    ...
    public function init()
    {
        ...
        if (Yii::$app instanceof \yii\console\Application) $this->controllerNamespace = 'vsdesk\builder\commands';
        else {
            // instanceof webapp
    ...
    protected function prepareDataFiles()
    {
        ...
        foreach ($this->commands as $cmd) {
            if (is_array($cmd)) {
                ...
                if ($model instanceof \vsdesk\builder\Generator === false)
                    throw new InvalidConfigException('generator should extend "\vsdesk\builder\Generator"');
