...
namespace vsdesk\builder\controllers;
...
use vsdesk\builder\models\Schema;
use vsdesk\builder\models\Entity;
use vsdesk\builder\models\Attribute;
use vsdesk\builder\models\Relationship;
use vsdesk\builder\models\EntitySearch;
